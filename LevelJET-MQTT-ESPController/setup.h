...
#define DEBUG 0 // Setzen Sie dies auf 1, um Debugging zu aktivieren, oder auf 0, um es zu deaktivieren
...
void callback(char* topic, byte* message, unsigned int length); // von LevelJET-MQTT-ESPController.ino 
